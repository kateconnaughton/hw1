...
-- movies to actor is many to one
-- movies to studio is many to one
...
INSERT INTO casting (character_name, actor_id, movie_id)
...
-- TODO!
SELECT movies.movie_title, actors.actor_name, casting.character_name
FROM casting
INNER JOIN movies ON movies.id = casting.movie_id
INNER JOIN actors ON actors.id = casting.actor_id
